...
func (s *ControllerOptions) AddFlags(fs *flag.FlagSet) {
	...
	fs.BoolVar(&s.Batching, "batching", true, "To enable batching of API calls (default to true). This is especially helpful for improving performance in workloads that are sensitive to EC2 rate limits.")
}
